    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(60000,1000){
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(NinethActivity.this);
                ...
                alert.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(NinethActivity.this,"Oyun Bitti",Toast.LENGTH_LONG);
                    }
                });
                alert.show();
            }
    ...
    public void increaseScor(View view){
        ...
        if(number>=30){
            ...
            alert.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent=new Intent(NinethActivity.this,MainActivity.class);
                    startActivity(intent);
