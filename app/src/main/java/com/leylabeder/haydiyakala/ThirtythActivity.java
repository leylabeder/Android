    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(60000,1000){
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(ThirtythActivity.this);
                ...
                alert.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(ThirtythActivity.this,"Oyun Bitti",Toast.LENGTH_LONG);
                    }
                });
                alert.show();
            }
        ...
        if(number>=30){
            ...
            alert.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent=new Intent(ThirtythActivity.this, FourtyActivity.class);
                    startActivity(intent);
            ...
            alert.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent=new Intent(ThirtythActivity.this,MainActivity.class);
                    startActivity(intent);
