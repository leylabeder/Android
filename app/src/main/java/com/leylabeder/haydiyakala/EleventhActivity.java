    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(60000,1000){
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(EleventhActivity.this);
                ...
                alert.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(EleventhActivity.this,"Oyun Bitti",Toast.LENGTH_LONG);
                    }
                });
                alert.show();
            }
        ...
        if(number>=30){
            ...
            alert.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent=new Intent(EleventhActivity.this, TwentythActivity.class);
                    startActivity(intent);
